/**
 * Selection type configurations for Vue demo
...
/**
 * Get search highlight type with localization
 */
export function getSearchHighlightType(locale: Locale = 'en'): SelectionTypeConfig {
  const t = messages[locale].selectionTypes
  return {
    type: BASE_SEARCH_TYPE.type,
    label: t.search.label,
...
export const SEARCH_HIGHLIGHT_TYPE = getSearchHighlightType('en')
