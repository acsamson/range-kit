...
import { VitePluginBesDemandImport } from '../../../audit-util/src/node'
...
export default defineConfig({
  ...
  vite: {
    plugins: [
      VitePluginBesDemandImport({
        libs: ['@ad-audit/orz-ui-next', '@ad-audit/util']
      })
    ],
    resolve: {
      alias: {
    ...
    ssr: {
      noExternal: ['element-plus', '@tiptap/core', '@tiptap/starter-kit', '@ad-audit/orz-ui-next', '@ad-audit/range-sdk']
    },
    css: {
      preprocessorOptions: {
        scss: {
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/your-org/range-sdk' }
    ],
