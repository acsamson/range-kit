...
import type { HighlightStyle, SelectionTypeConfig } from '../types';
...
export function setHighlightStyle(
  ...
  options.highlightStyle = { ...options.highlightStyle, ...style };
  deps.highlighter.setDefaultStyle(options.highlightStyle);
}
