 ...
 * 纯粹的结构相似度计算
 */
export function calculateStructuralSimilarity(element: Element, fingerprint: any): number {
  let score = 0;
  let maxScore = 0;
 ...
 * 父链相似度计算
 */
export function calculateParentChainSimilarity(element: Element, targetParentChain: any[]): number {
