...
describe('SelectionInstanceManager', () => {
  ...
  describe('addSelection', () => {
    ...
    it('should use default type if not specified', () => {
      ...
      expect(instance.type).toBe('comment'); // default from mockOptions
    });
  ...
  describe('getStyleForType', () => {
    ...
    it('should return default style for unknown type', () => {
      ...
      expect(style).toEqual(mockOptions.highlightStyle);
    });
  });
