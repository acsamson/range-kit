...
describe('SelectionManager', () => {
  ...
  describe('constructor', () => {
    it('should accept string container ID', () => {
      ...
      expect(manager.getContainerSelectorString()).toBe('#test-container');
    });
    ...
    it('should generate ID for element without ID', () => {
      ...
      expect(manager.getContainerSelectorString()).toMatch(/^#range-kit-container-/);
  ...
  describe('getSelectionRestoreInstance', () => {
    beforeEach(() => {
      manager = new SelectionManager(container);
    });

    it('should return the internal SelectionRestore instance', () => {
      const instance = manager.getSelectionRestoreInstance();

      expect(instance).toBeDefined();
      expect(typeof instance.serialize).toBe('function');
      expect(typeof instance.restore).toBe('function');
    });
  });
